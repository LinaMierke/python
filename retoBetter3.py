estudiante = str(input("Ingrese Nombre y Apellidos del estudiante: "))
...
valor_matricula = int(input("Ingrese el valore de la matricula: "))
descuento_edad = 0
descuento_salario = 0
descuento_puntaje = 0
...
suma_total_descuentos = descuento_edad + descuento_puntaje + descuento_salario
print("El descuento total es : ", suma_total_descuentos * 100, "%")

valor_descontar = valor_matricula * suma_total_descuentos
print("El valor a descontar es : ", valor_descontar)

total_valor_pagar = valor_matricula - valor_descontar

print("Total a pagar: ", total_valor_pagar)
